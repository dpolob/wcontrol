...
BATCH_SIZE = 1
EPOCHS = 30
NAME = f'seq2seq-MODEL2-2layer-nodropout-{PASADO}-{FUTURO}-Max'
device = 'cuda'
...
class LossFunction():
    ...
    def __call__(self, y_pred, y):
        return torch.max(self.lf2(y_pred, y))
...
trainer._load_checkpoint(epoch=50)
...
plt.plot(predicciones.iloc[567].loc['Y'], 'b')
plt.plot(predicciones.iloc[567].loc['Ypred'], 'r')
