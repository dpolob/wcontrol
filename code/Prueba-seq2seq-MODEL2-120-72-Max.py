...
BATCH_SIZE = 1
EPOCHS = 30
NAME = f'seq2seq-MODEL2-{PASADO}-{FUTURO}-Max'
device = 'cuda'
...
trainer._load_checkpoint(epoch=24)
...
plt.plot(predicciones.iloc[1000].loc['Y'], 'b')
plt.plot(predicciones.iloc[1000].loc['Ypred'], 'r')
